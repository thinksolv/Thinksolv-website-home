...
export function FeatureCard({ icon: Icon, title, description }: FeatureCardProps) {
  return (
    <div className="group relative bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-black dark:border-white shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105 dark:bg-black">
